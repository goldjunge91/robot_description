...
def generate_launch_description():
    ...
    declare_components_config_arg = DeclareLaunchArgument(
        ...
        description=(
            ...
            "Available options can be found in [components_description](https://github.com/goldjunge91/components_description/blob/jazzy/README.md#available-urdf-sensors)"
        ),
    )
